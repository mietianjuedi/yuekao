			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-body">
				    	...
				    	<p>
				    		<form:textarea path="content" id="content" rows="15" placeholder="博客内容" class="form-control"></form:textarea>
				    		<span class="red">
				    		<form:errors path="content"/></span>
				    	</p>
				    	
				    	<p>
				    		<form:textarea path="summary" rows="1" class="form-control" placeholder="摘要"></form:textarea>
